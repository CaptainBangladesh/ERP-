    ...
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center gap-8 p-6">
      ...
      >
        ...
        {/*
          ...
          There is no "confirm password" box. That field earned its place only because a
          mistyped password was unrecoverable — the first and only user of a brand-new
          company, with no reset link and no colleague to let them back in — and account
          recovery now exists precisely to close that gap. What is left to guard against a
          typo is `Field`'s own reveal toggle, which lets somebody check what they typed
          without a second box to keep in step with the first.
        */}
