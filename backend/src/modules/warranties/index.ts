 ...
 * the question another module may ask — with 'WarrantiesService' bound to it in the Nest
 * module, and 'WarrantiesModule' exported beside it, because a consumer has to import
