 ...
 * the question another module may ask — with 'MarketingService' bound to it in the Nest
 * module, and 'MarketingModule' exported beside it, because a consumer has to import
